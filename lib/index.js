...
const deprecationCheckMiddleware = (specs) =>
  specs.options.onDeprecated ? enabledDeprecationMiddleware(specs) : disabledDeprecationMiddleware;

const createHandlerWrapper = (versionName) => (handler) => (req, res, next) => {
